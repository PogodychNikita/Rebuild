...
public class BuildAllMartDefenses : Mission
{
    public BuildAllMartDefenses()
    { 
    ...
    public override void Calculate(List<Survivor> sel)
    {
        ...
        {
            SelSurv.Add(sel[i]);
            SelSurv[i].Status = "Building AllMart Defenses";
    ...
    public override void Execute()
    {
        ...
        else
        {
            ...
            GameObject newGameObj = GameObject.Instantiate(Resources.Load("Prefabs/Locations/SecureAllMart")) as GameObject;
            ...
            MainScript.Map[tempId.x + 1][tempId.y] = newGameObj.GetComponent<Location>();
