...
public class ReplaceWithFarm : Mission
{
    public ReplaceWithFarm()
    { 
    ...
    public override void Execute()
    {
        ...
        else
        {
            ...
            GameObject newGameObj = GameObject.Instantiate(Resources.Load("Prefabs/Locations/Farm")) as GameObject;
